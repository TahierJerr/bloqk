    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground">
          De klant ziet de previewlink direct in z&apos;n voortgangsoverzicht en
          kan goedkeuren of feedback geven.
        </p>
      </form>
    );
  }
    ...
    return (
      <div className="flex flex-col gap-3">
        <p className="text-sm text-muted-foreground">
          De betaling is binnen. Staat de site live? Dan ontgrendelt deze knop
          het dashboard voor de klant.
        </p>
        {error && (
